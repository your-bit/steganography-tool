...
<p align="center">
  <strong>Advanced Web-Based Steganography Toolkit with Three Hiding Methods</strong>
</p>
...
**Steganography Pro** is a modern web-based tool that allows you to securely hide any file inside an image using **three steganography methods**: Basic LSB, Enhanced LSB, and File Append.  
Built with a responsive dark UI, this project is ideal for students, researchers, and cybersecurity enthusiasts studying data hiding and digital forensics.
...
- 🎨 **Dark Professional UI** — Elegant, minimal, and fully responsive  
- 📊 **Real-Time Capacity Calculator** — Know how much data fits in your image  
- 🔐 **Optional Password Field** — (for user-added encryption before embedding)  
- 🖱️ **Drag & Drop Uploads** — Smooth, modern experience  
...
### 🧩 Online Demo
👉 [GitHub Pages Link](https://your-bit.github.io/steganography-tool)
